...
namespace Bookify2.Data.Migrations
{
    ...
    [Migration("20240721114343_AddRentals_AddRentalsCopiesTables")]
    partial class AddRentals_AddRentalsCopiesTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Core.Models.Area", b =>
                {
            ...
            modelBuilder.Entity("Bookify.Core.Models.Governorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Core.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Core.Models.RentalCopy", b =>
                {
            ...
            modelBuilder.Entity("Bookify.Core.Models.Subscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Core.Models.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Core.Models.Area", b =>
                {
                    ...
                    b.HasOne("Bookify.Core.Models.Governorate", "Governorate")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Bookify.Core.Models.Rental", b =>
                {
                    ...
                    b.HasOne("Bookify.Core.Models.Subscriber", "Subscriber")
                        .WithMany("Rentals")
            ...
            modelBuilder.Entity("Bookify.Core.Models.RentalCopy", b =>
                {
                    b.HasOne("Bookify.Core.Models.BookCopy", "BookCopy")
                        .WithMany()
                        .HasForeignKey("BookCopyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bookify.Core.Models.Rental", "Rental")
            ...
            modelBuilder.Entity("Bookify.Core.Models.Subscriber", b =>
                {
                    b.HasOne("Bookify.Core.Models.Area", "Area")
                        .WithMany()
