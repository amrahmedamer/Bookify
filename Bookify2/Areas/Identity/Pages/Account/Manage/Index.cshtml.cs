    ...
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Phone number"),
                RegularExpression(RegexPattern.PhoneNumber, ErrorMessage = Errors.PhoneNumber)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Avatar is not null)
            {
                ...
                var (isUploaded, errorMessage) = await _imageService.UploadAsync(Input.Avatar, $"{user.Id}.png", $"/Images/Users/", thumbnail: false);
