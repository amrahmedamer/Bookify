...
namespace Bookify.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var callbackUrl = Url.Page(
                    ...
                    pageHandler: null,
                    values: new { area = "Identity", userId = userId, email = Input.NewEmail, code },
                    protocol: Request.Scheme);

                var placeholders = new Dictionary<string, string>()
                {
                    {  "imageUrl","https://res.cloudinary.com/cloudomar/image/upload/c_thumb,w_200,g_face/v1720307102/Mail_sent-rafiki_guuyyt.png" },
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(email, "Change your Email", body);
